      ...
      <div className={`dashboard-content ${sidebarCollapsed ? 'collapsed' : ''}`}>
        ...
        <main className="dashboard-main">
          <div className="main-content">
            {/* KPI cards at top of page content */}
            <KPICards
              stats={[
                { value: 12, label: "Documents uploaded" },
                { value: 48, label: "Chats this week" },
                { value: 5,  label: "New insights" }
              ]}
            />
          ...
          {/* Right rail with recent activity */}
          <RecentActivity
            chats={[
